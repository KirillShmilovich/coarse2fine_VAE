...
class OpenMMEnergy(Energy):
    def __init__(self, dimension, pdb_fname):
        ...
        charmm_tops_fname = "/scratch/midway3/kirills/c2f/charmm_tops"
        ...
        # ### self.system = self.forcefield.createSystem(self.pdb.topology, constraints=app.HBonds, nonbondedCutoff=0.9
        # * u.angstrom, nonbondedMethod=app.PME)
        # ##self.system = self.forcefield.createSystem(
        # ##    self.pdb.topology, nonbondedMethod=app.NoCutoff
        # ##)
        #
